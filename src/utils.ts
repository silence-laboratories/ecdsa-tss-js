...
export function paillierPrivateKeyFromObj(key: any): paillier.PrivateKey {
...
export function signatureToHex(r: bigint, s: bigint, order = 32) {
  return (Uint8ArrayToHex(bigintToUint8Array(r, order)) + Uint8ArrayToHex(bigintToUint8Array(s, order)));
}

export async function verifySignature(messageHash: Uint8Array, publicKey: secp.Point, signature: string) {
...
export function comparePaillierPublicKey(key1: paillier.PublicKey, key2: paillier.PublicKey) {
