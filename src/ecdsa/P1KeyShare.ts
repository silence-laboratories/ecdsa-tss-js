...
import {
    bigintToHex,
    hexToBigint,
    hexToPoint, paillierPrivateKeyFromObj,
    paillierPrivateKeyToObj, paillierPublickeyFromStr,
...
export class P1KeyShare {
    static requiredFields = ['x1', 'public_key', 'paillier_private_key', 'paillier_public_key'];
